...
#               
# Notes: 
# 1. List the output of existing API Connectors in a specific resource group to print only the API Connector name instead of the full ID to be simple to read
# 2. List the output of API Connectors bind to a Logic App group by each Logic App to be simple to read                                        
# 3. List the output of deprecated API Connector to include only connectors are deprecated to be simple to read – this is the main point of the script. give the list of deprecated/orphaned connectors
# 4. Add a Deprecated tag on all the API Connectors
#########################################################
